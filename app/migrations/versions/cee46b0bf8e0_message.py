...
def upgrade() -> None:
    ...
    order_type = op.create_table('order_type',
    ...
    order_type_param = op.create_table('order_type_param',
    sa.Column('name', sa.String(length=100), nullable=True),
    ...
    order_type_params = [
        {'id': gen_id(), 'name': 'Название', 'required': True, 'order_type_id': order_types[0]['id'], 'value_type': 'string', },
        {'id': gen_id(), 'name': 'Описание', 'required': True, 'order_type_id': order_types[0]['id'], 'value_type': 'string', },
        {'id': gen_id(), 'name': 'Бюджет', 'required': True, 'order_type_id': order_types[0]['id'], 'value_type': 'int', },
        {'id': gen_id(), 'name': 'Название', 'required': True, 'order_type_id': order_types[1]['id'], 'value_type': 'string', },
        {'id': gen_id(), 'name': 'Описание', 'required': False, 'order_type_id': order_types[1]['id'], 'value_type': 'string', },
        {'id': gen_id(), 'name': 'Объем девесины, м3', 'required': True, 'order_type_id': order_types[1]['id'], 'value_type': 'int', },
        {'id': gen_id(), 'name': 'Срок исполнения', 'required': True, 'order_type_id': order_types[1]['id'], 'value_type': 'date', },
        {'id': gen_id(), 'name': 'Причина отказа', 'required': True, 'order_type_id': order_types[2]['id'], 'value_type': 'string', },
    ]
