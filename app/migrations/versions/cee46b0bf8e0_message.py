...
def upgrade() -> None:
    ...
    conn = op.get_bind()
    op.bulk_insert(order_type,
                   [
                       {'id': '1', 'name': 'Заказ на баню'},
                       {'id': '2', 'name': 'Заявка на сруб'},
                       {'id': '3', 'name': 'Заявка на брак сруба'},
                   ]
                   )
    ...
    op.bulk_insert(order_type_param,
                   [
                       {'id': '1', 'name': 'Название', 'required': True, 'order_type_id': '1', 'value_type': 'string', },
                       {'id': '2', 'name': 'Описание', 'required': True, 'order_type_id': '1', 'value_type': 'string', },
                       {'id': '3', 'name': 'Бюджет', 'required': True, 'order_type_id': '1', 'value_type': 'int', },
                       {'id': '4', 'name': 'Название', 'required': True, 'order_type_id': '2', 'value_type': 'string', },
                       {'id': '5', 'name': 'Описание', 'required': False, 'order_type_id': '2', 'value_type': 'string', },
                       {'id': '6', 'name': 'Объем девесины, м3', 'required': True, 'order_type_id': '2', 'value_type': 'int', },
                       {'id': '7', 'name': 'Срок исполнения', 'required': True, 'order_type_id': '2', 'value_type': 'date', },
                       {'id': '8', 'name': 'Причина отказа', 'required': True, 'order_type_id': '3', 'value_type': 'string', },
                   ]
                   )
