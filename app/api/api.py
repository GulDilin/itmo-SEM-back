...
from app.api.endpoints import (admin, order, order_param_value,
                               order_status_update, order_type,
                               order_type_param)
...
router.include_router(order_status_update.router, prefix='/order_status_update', tags=['Order Status Update'])
